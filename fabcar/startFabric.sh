...
# don't rewrite paths for Windows Git Bash users(Windows Git Bash 사용자의 경로를 다시 작성하지 마십시오.)
...
# launch network; create channel and join peer to channel(네트워크 구동; 채널을 만들고 채널에 피어를 가입합니다.)
cd ../basic-network
./start.sh

# Now launch the CLI container in order to install, instantiate chaincode
# and prime the ledger with our 10 cars
# (이제 10 개의 자동차로 체인 코드를 설치하고 인스턴스화하고 원장을 프라임하기 위해 CLI 컨테이너를 실행하십시오.)
